...
export class AuthComponent {
  ...
  ngOnInit() {
    ...
    let compteAdmin = {
      ...
      passwordAdminLogin: 'passer12345',
    }
  ...
  connexion(){
    ...
    if(this.emailLogin == "" || this.passwordLogin == "" ){
      this.alertMessage("error", "Attention", "Vueillez renseigner tous les champs", timer);
      ...
      if (this.userApprenantFound) {
        ...
        this.alertMessage("success", "Bravo", "Vous etes connecté avec succés", timer);
        this.route.navigate(['professeur',this.userFormateurFound.idFormateur]);
      } 
      else {
